...
BINSET = "Hertkorn2013_MeOD"
bins_dat = set_bins(BINSET)

# STEP 2: set input directories -------------------------------------------
SPECTRA_FILES = "data/AMP_incubations/spectra/"
PEAKS_FILES = "data/AMP_incubations/peaks/"

# STEP 3: process spectra and peak data -----------------------------------
spectra_processed = import_nmr_spectra_data(SPECTRA_FILES)
peaks_processed = import_nmr_peaks2(PEAKS_FILES)
...
## 5a. load corekey
COREKEY = "data/AMP_incubations/corekey.csv"
